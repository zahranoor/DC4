 ...
 *  Sets the styles.
 *
 *   {Object} styles The style to set.
 */
 ...
 *
 *  {boolean} True if zoomOnClick_ is set.
 */
 ...
 *
 *  {boolean} True if averageCenter_ is set.
 */
 ...
 *
 *   {Array.<google.maps.Marker>} The markers.
 */
 ...
 *
 *   {number} maxZoom The max zoom level.
 */
 ...
 *
 *   {Array.<google.maps.Marker>} markers The markers in the clusterer.
 *   {number} numStyles The number of styles available.
 *   {Object} A object properties: 'text' (string) and 'index' (number).
 *
 */
 ...
 *
 *  {function(Array, number)} calculator The function to set as the
 ...
 *
 *  {function(Array, number)} the calculator function.
 */
 ...
 *  {boolean=} opt_nodraw Whether to redraw the clusters.
 */
 ...
 *
 *  {google.maps.Marker} marker The marker to remove.
 *  {boolean=} opt_nodraw Optional boolean to force no redraw.
 *  {boolean} True if the marker was removed.
 */
 ...
 *  {boolean} opt_hide To also hide the marker.
 */
 ...
 *
 *  {MarkerClusterer} markerClusterer The markerclusterer that this
 ...
 *
 *  {google.maps.Marker} marker The marker to check.
 *  {boolean} True if the marker is already added.
 */
 ...
 *
 *  {Array.<google.maps.Marker>} The markers in the cluster.
 */
 ...
 *
 *  {google.maps.LatLng} The cluster center.
 */
 ...
 *  {Object} styles An object that has style properties:
 ...
 *  {number=} opt_padding Optional padding to apply to the cluster icon.
 *
 ...
 *
 *  {Object} sums The sums containing:
 ...
 *
 *  {google.maps.Point} pos The position.
